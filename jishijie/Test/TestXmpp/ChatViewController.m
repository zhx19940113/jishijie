...
- (void)getChatHistory
{
    XMPPMessageArchivingCoreDataStorage *storage = [XMPPTool sharedInstance].xmppMessageArchivingCoreDataStorage;
    //查询的时候要给上下文
...
- (XMPPOutgoingFileTransfer *)xmppOutgoingFileTransfer
{
    if (!_xmppOutgoingFileTransfer) {
        ...
        [_xmppOutgoingFileTransfer activate:[XMPPTool sharedInstance].xmppStream];
...
- (IBAction)sendRecord:(id)sender {
    [_recorder stop];
    NSArray *resources = [[XMPPTool sharedInstance].xmppRosterMemoryStorage sortedResources:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    contentLabel.text = [message.body stringByAppendingString:@"定制"];
...
- (void)xmppOutgoingFileTransferDidSucceed:(XMPPOutgoingFileTransfer *)sender
{
    ...
    [message addAttributeWithName:@"from" stringValue:[XMPPTool sharedInstance].xmppStream.myJID.bare];
    ...
    [[XMPPTool sharedInstance].xmppMessageArchivingCoreDataStorage archiveMessage:message outgoing:NO xmppStream:[XMPPTool sharedInstance].xmppStream];
}
